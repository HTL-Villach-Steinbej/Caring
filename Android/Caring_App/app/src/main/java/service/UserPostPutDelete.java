...
public class UserPostPutDelete  extends AsyncTask<CarUpd.COMMAND, Void, String> {
    private static final String URL = "/Caring_WebService/Caring/user";
    ...
    @Override
    protected String doInBackground(CarUpd.COMMAND... commands) {
        ...
        try {
            ...
            switch (commands[0]) {
                ...
                case PUT:
                    ...
                    break;
                default:
                    throw new Exception("Error: command " + commands[0] + " is not allowed!");
            }
