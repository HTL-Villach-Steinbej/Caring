...
public class CarLocation extends AppCompatActivity implements PermissionsListener, OnMapReadyCallback {
...
// Initialize the mapboxMap view
    ...
    public void onMapReady(@NonNull final MapboxMap mapboxMap) {
        CarLocation.this.mapboxMap = mapboxMap;
...
// Transform the appearance of the button to become the cancel button
                            selectLocationButton.setBackgroundColor(
                                    ContextCompat.getColor(CarLocation.this, R.color.colorAccent));
...
// Switch the button appearance back to select a location.
                            selectLocationButton.setBackgroundColor(
                                    ContextCompat.getColor(CarLocation.this, R.color.colorPrimary));
